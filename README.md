...
* [Monospace for Markdown Editors](https://github.com/DanielNetoP/markdown-monospace) **[Archived]** - Monospace font for Standard Notes markdown editors (Toggle on top of other themes)
...
* [Marp Editor](https://github.com/TheodoreChu/marp-editor) **[Archived]** - Create presentation slides with [Marp](https://marp.app) and [Marpit Markdown](https://marpit.marp.app/markdown).
* [Music Editor](https://github.com/TheodoreChu/music-editor) **[Archived]** - Write music with [VexTab](https://github.com/0xfe/vextab) and [VexFlow](https://github.com/0xfe/vexflow).
...
* [Tui Markdown Editor](https://github.com/MortalHappiness/sn-tui.editor) **[Archived]** - A markdown editor using [Toast UI Markdown Editor](https://github.com/nhn/tui.editor).
