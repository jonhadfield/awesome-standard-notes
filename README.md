...
* [sn-cli](https://github.com/jonhadfield/sn-cli) - Manage notes, tags, and other account operations <sub><sup>([version 003](a "not compatible with version 004 accounts: those created or upgraded after Nov 2020"))</sub></sup>
* [sn-dotfiles](https://github.com/jonhadfield/sn-dotfiles) - Sync and manage dotfiles using Standard Notes <sub><sup>([version 003](a "not compatible with version 004 accounts: those created or upgraded after Nov 2020"))</sub></sup>
...
## Libraries
* [gosn-v2](https://github.com/jonhadfield/gosn-v2) - A library written in Go <sub><sup>([version 003](a "not compatible with version 004 accounts: those created or upgraded after Nov 2020"))</sub></sup>
...
## Clients
* [Iridium](https://github.com/standardnotes/forum/issues/1135) - A local-first client written in Rust and GTK, with support for any server and offline editing <sub><sup>([version 003](a "not compatible with version 004 accounts: those created or upgraded after Nov 2020"))</sub></sup>
